\startenvironment env_NotesDeCours
  ...
  \def\commencerThm[#1][#2][#3]{%
    \csname start#1ENUM\endcsname[title={#2}, reference={#3}]%
    \page[no]%
    \startlisereGauche%
  }
  ...
  \def\dostarttheoreme[#1][#2]{%
    \commencerThm[theoreme][#1][thm:#2]}
  \def\dostartproposition[#1][#2]{%
    \commencerThm[proposition][#1][prop:#2]}
  \def\dostartlemme[#1][#2]{%
    \commencerThm[lemme][#1][lem:#2]}
  \def\dostartcorollaire[#1][#2]{%
    \commencerThm[corollaire][#1][cor:#2]}
